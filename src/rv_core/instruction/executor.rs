...
impl<'m> Executor<'m> {
    pub fn new(registers: &'m mut Registers, memory: &'m mut Memory, vec_engine: &'m mut VectorEngine) -> Self {
        Self { registers, memory, vec_engine }
    }
    ...
    pub fn execute(&mut self, input: Instruction) {
        ...
        match input {
            ...
            Vsetvli(args) => v::vsetvli(
                ...
                &self.registers.v, &self.vec_engine,
            ...
            Vlv { data: args, eew } => v::vl::v(
                ...
                &self.registers.x,
                &mut self.registers.v, &self.vec_engine,
                &self.memory,
            ),
            ...
            Vluxv { data: args, eew } => v::vlux::v(args, SEW::try_from(eew).unwrap(), &mut self.registers.v, &self.vec_engine, &self.registers.x, &self.memory),
            Vloxv { data: args, eew } => v::vlox::v(args, SEW::try_from(eew).unwrap(), &mut self.registers.v, &self.vec_engine, &self.registers.x, &self.memory),
            Vsuxv { data: args, eew } => v::vsux::v(args, eew, &self.registers.v, &self.vec_engine, &mut self.memory),
            Vsoxv { data: args, eew } => v::vsox::v(args, eew, &self.registers.v, &self.vec_engine, &mut self.memory),

            Vlffv { data: args, eew } => v::vlff::v(args, SEW::try_from(eew).unwrap(), &mut self.registers.v, &self.vec_engine, &self.registers.x, &mut self.registers.c, &self.memory),

            Vlsegv {
                data: args,
                eew,
                nf,
            } => v::vlseg::v(args, SEW::try_from(eew).unwrap(), nf, &mut self.registers.v, &self.vec_engine, &self.registers.x, &self.memory),
            Vssegv {
                data: args,
                eew,
                nf,
            } => v::vsseg::v(args, eew, nf, &self.registers.v, &self.vec_engine, &mut self.memory),

            Vlssegv {
                data: args,
                eew,
                nf,
            } => v::vlsseg::v(args, eew, nf, &mut self.registers.v, &self.vec_engine, &self.memory),
            Vsssegv {
                data: args,
                eew,
                nf,
            } => v::vssseg::v(args, eew, nf, &self.registers.v, &self.vec_engine, &mut self.memory),

            Vluxsegv {
                data: args,
                eew,
                nf,
            } => v::vluxseg::v(args, eew, nf, &mut self.registers.v, &self.vec_engine, &self.memory),
            Vloxsegv {
                data: args,
                eew,
                nf,
            } => v::vloxseg::v(args, eew, nf, &mut self.registers.v, &self.vec_engine, &self.memory),
            Vsuxsegv {
                data: args,
                eew,
                nf,
            } => v::vsuxseg::v(args, eew, nf, &self.registers.v, &self.vec_engine, &mut self.memory),
            Vsoxsegv {
                data: args,
                eew,
                nf,
            } => v::vsoxseg::v(args, eew, nf, &self.registers.v, &self.vec_engine, &mut self.memory),

            Vlrv {
                data: args,
                eew,
                nf,
            } => v::vlr::v(args, eew, nf, &mut self.registers.v, &self.vec_engine, &self.memory),
            Vsrv { data: args, nf } => v::vsr::v(args, nf, &self.registers.v, &self.vec_engine, &mut self.memory),

            Vaddvv(args) => v::vadd::vv(args, &mut self.registers.v, &self.vec_engine),
            Vaddvx(args) => v::vadd::vx(args, &mut self.registers.v, &self.vec_engine, &self.registers.x),
            ...
            Vsubvx(args) => v::vsub::vx(args, &mut self.registers.v, &self.vec_engine, &self.registers.x),

            Vrsubvx(args) => v::vrsub::vx(args, &mut self.registers.v, &self.vec_engine, &self.registers.x),
            ...
            Vminuvx(args) => v::vminu::vx(args, &mut self.registers.v, &self.vec_engine, &self.registers.x),

            Vminvv(args) => v::vmin::vv(args, &mut self.registers.v, &self.vec_engine),
            Vminvx(args) => v::vmin::vx(args, &mut self.registers.v, &self.vec_engine, &self.registers.x),

            Vmaxuvv(args) => v::vmaxu::vv(args, &mut self.registers.v, &self.vec_engine),
            Vmaxuvx(args) => v::vmaxu::vx(args, &mut self.registers.v, &self.vec_engine, &self.registers.x),

            Vmaxvv(args) => v::vmax::vv(args, &mut self.registers.v, &self.vec_engine),
            Vmaxvx(args) => v::vmax::vx(args, &mut self.registers.v, &self.vec_engine, &self.registers.x),

            Vandvv(args) => v::vand::vv(args, &mut self.registers.v, &self.vec_engine),
            Vandvx(args) => v::vand::vx(args, &mut self.registers.v, &self.vec_engine, &self.registers.x),
            ...
            Vorvx(args) => v::vor::vx(args, &mut self.registers.v, &self.vec_engine, &self.registers.x),
            ...
            Vxorvx(args) => v::vxor::vx(args, &mut self.registers.v, &self.vec_engine, &self.registers.x),
            ...
            Vrgathervx(args) => v::vrgather::vx(args, &mut self.registers.v, &self.vec_engine, &self.registers.x),
            Vrgathervi(args) => v::vrgather::vi(args, &mut self.registers.v, &self.vec_engine),

            Vrgatherei16vv(args) => v::vrgatherei16::vv(args, &mut self.registers.v, &self.vec_engine),

            Vslideupvx(args) => v::vslideup::vx(args, &mut self.registers.v, &self.vec_engine, &self.registers.x),
            Vslideupvi(args) => v::vslideup::vi(args, &mut self.registers.v, &self.vec_engine),

            Vslidedownvx(args) => v::vslidedown::vx(args, &mut self.registers.v, &self.vec_engine, &self.registers.x),
            ...
            Vadcvxm(args) => v::vadc::vxm(args, &mut self.registers.v, &self.vec_engine, &self.registers.x),
            ...
            Vmadcvxm(args) => v::vmadc::vxm(args, &mut self.registers.v, &self.vec_engine, &self.registers.x),
            ...
            Vmadcvx(args) => v::vmadc::vx(args, &mut self.registers.v, &self.vec_engine, &self.registers.x),
            ...
            Vsbcvxm(args) => v::vsbc::vxm(args, &mut self.registers.v, &self.vec_engine, &self.registers.x),

            Vmsbcvvm(args) => v::vmsbc::vvm(args, &mut self.registers.v, &self.vec_engine),
            Vmsbcvxm(args) => v::vmsbc::vxm(args, &mut self.registers.v, &self.vec_engine, &self.registers.x),

            Vmsbcvv(args) => v::vmsbc::vv(args, &mut self.registers.v, &self.vec_engine),
            Vmsbcvx(args) => v::vmsbc::vx(args, &mut self.registers.v, &self.vec_engine, &self.registers.x),

            Vmergevvm(args) => v::vmerge::vvm(args, &mut self.registers.v, &self.vec_engine),
            Vmergevxm(args) => v::vmerge::vxm(args, &mut self.registers.v, &self.vec_engine, &self.registers.x),
            ...
            Vmvvx(args) => v::vmv::vx(args, &mut self.registers.v, &self.vec_engine, &self.registers.x),
            ...
            Vmseqvx(args) => v::vmseq::vx(args, &mut self.registers.v, &self.vec_engine, &self.registers.x),
            ...
            Vmsnevx(args) => v::vmsne::vx(args, &mut self.registers.v, &self.vec_engine, &self.registers.x),
            ...
            Vmsltuvx(args) => v::vmsltu::vx(args, &mut self.registers.v, &self.vec_engine, &self.registers.x),

            Vmsltvv(args) => v::vmslt::vv(args, &mut self.registers.v, &self.vec_engine),
            Vmsltvx(args) => v::vmslt::vx(args, &mut self.registers.v, &self.vec_engine, &self.registers.x),

            Vmsleuvv(args) => v::vmsleu::vv(args, &mut self.registers.v, &self.vec_engine),
            Vmsleuvx(args) => v::vmsleu::vx(args, &mut self.registers.v, &self.vec_engine, &self.registers.x),
            ...
            Vmslevx(args) => v::vmsle::vx(args, &mut self.registers.v, &self.vec_engine, &self.registers.x),
            Vmslevi(args) => v::vmsle::vi(args, &mut self.registers.v, &self.vec_engine),

            Vmsgtuvx(args) => v::vmsgtu::vx(args, &mut self.registers.v, &self.vec_engine, &self.registers.x),
            Vmsgtuvi(args) => v::vmsgtu::vi(args, &mut self.registers.v, &self.vec_engine),

            Vmsgtvx(args) => v::vmsgt::vx(args, &mut self.registers.v, &self.vec_engine, &self.registers.x),
            ...
            Vsadduvx(args) => v::vsaddu::vx(args, &mut self.registers.v, &self.vec_engine, &self.registers.x),
            ...
            Vsaddvx(args) => v::vsadd::vx(args, &mut self.registers.v, &self.vec_engine, &self.registers.x),
            ...
            Vssubuvx(args) => v::vssubu::vx(args, &mut self.registers.v, &self.vec_engine, &self.registers.x),

            Vssubvv(args) => v::vssub::vv(args, &mut self.registers.v, &self.vec_engine),
            Vssubvx(args) => v::vssub::vx(args, &mut self.registers.v, &self.vec_engine, &self.registers.x),

            Vsllvv(args) => v::vsll::vv(args, &mut self.registers.v, &self.vec_engine),
            Vsllvx(args) => v::vsll::vx(args, &mut self.registers.v, &self.vec_engine, &self.registers.x),
            Vsllvi(args) => v::vsll::vi(args, &mut self.registers.v, &self.vec_engine),

            Vsmulvv(args) => v::vsmul::vv(args, &mut self.registers.v, &self.vec_engine, &mut self.registers.c),
            ...
            Vsrlvx(args) => v::vsrl::vx(args, &mut self.registers.v, &self.vec_engine, &self.registers.x),
            ...
            Vsravx(args) => v::vsra::vx(args, &mut self.registers.v, &self.vec_engine, &self.registers.x),
            ...
            Vssrlvx(args) => v::vssrl::vx(args, &mut self.registers.v, &self.vec_engine, &self.registers.x),
            ...
            Vssravx(args) => v::vssra::vx(args, &mut self.registers.v, &self.vec_engine, &self.registers.x),
            ...
            Vnsrlwx(args) => v::vnsrl::wx(args, &mut self.registers.v, &self.vec_engine, &self.registers.x),
            ...
            Vnsrawx(args) => v::vnsra::wx(args, &mut self.registers.v, &self.vec_engine, &self.registers.x),
            Vnsrawi(args) => v::vnsra::wi(args, &mut self.registers.v, &self.vec_engine),

            Vnclipuwv(args) => v::vnclipu::wv(args, &mut self.registers.v, &self.vec_engine, &mut self.registers.c),
            ...
            Vnclipuwi(args) => v::vnclipu::wi(args, &mut self.registers.v, &self.vec_engine, &mut self.registers.c),

            Vnclipwv(args) => v::vnclip::wv(args, &mut self.registers.v, &self.vec_engine, &mut self.registers.c),
            ...
            Vnclipwi(args) => v::vnclip::wi(args, &mut self.registers.v, &self.vec_engine, &mut self.registers.c),
            ...
            Vaadduvv(args) => v::vaaddu::vv(args, &mut self.registers.v, &self.vec_engine, &self.registers.c),
            ...
            Vaaddvv(args) => v::vaadd::vv(args, &mut self.registers.v, &self.vec_engine, &self.registers.c),
            ...
            Vasubuvv(args) => v::vasubu::vv(args, &mut self.registers.v, &self.vec_engine, &self.registers.c),
            ...
            Vasubvv(args) => v::vasub::vv(args, &mut self.registers.v, &self.vec_engine, &self.registers.c),
            ...
            Vslide1upvx(args) => v::vslide1up::vx(args, &mut self.registers.v, &self.vec_engine, &self.registers.x),

            Vslide1downvx(args) => {
                v::vslide1down::vx(args, &mut self.registers.v, &self.vec_engine, &self.registers.x)
            }

            Vmvxs(args) => v::vmv::xs(args, &self.registers.v, &self.vec_engine, &mut self.registers.x),
            Vcpopm(args) => v::vcpop::m(args, &self.registers.v, &self.vec_engine, &mut self.registers.x),
            Vfirstm(args) => v::vfirst::m(args, &self.registers.v, &self.vec_engine, &mut self.registers.x),

            Vmvsx(args) => v::vmv::sx(args, &mut self.registers.v, &self.vec_engine, &self.registers.x),
            ...
            Vdivuvx(args) => v::vdivu::vx(args, &mut self.registers.v, &self.vec_engine, &self.registers.x),

            Vdivvv(args) => v::vdiv::vv(args, &mut self.registers.v, &self.vec_engine),
            Vdivvx(args) => v::vdiv::vx(args, &mut self.registers.v, &self.vec_engine, &self.registers.x),

            Vremuvv(args) => v::vremu::vv(args, &mut self.registers.v, &self.vec_engine),
            Vremuvx(args) => v::vremu::vx(args, &mut self.registers.v, &self.vec_engine, &self.registers.x),

            Vremvv(args) => v::vrem::vv(args, &mut self.registers.v, &self.vec_engine),
            Vremvx(args) => v::vrem::vx(args, &mut self.registers.v, &self.vec_engine, &self.registers.x),

            Vmulhuvv(args) => v::vmulhu::vv(args, &mut self.registers.v, &self.vec_engine),
            Vmulhuvx(args) => v::vmulhu::vx(args, &mut self.registers.v, &self.vec_engine, &self.registers.x),

            Vmulvv(args) => v::vmul::vv(args, &mut self.registers.v, &self.vec_engine),
            Vmulvx(args) => v::vmul::vx(args, &mut self.registers.v, &self.vec_engine, &self.registers.x),

            Vmulhsuvv(args) => v::vmulhsu::vv(args, &mut self.registers.v, &self.vec_engine),
            Vmulhsuvx(args) => v::vmulhsu::vx(args, &mut self.registers.v, &self.vec_engine, &self.registers.x),

            Vmulhvv(args) => v::vmulh::vv(args, &mut self.registers.v, &self.vec_engine),
            Vmulhvx(args) => v::vmulh::vx(args, &mut self.registers.v, &self.vec_engine, &self.registers.x),

            Vmaddvv(args) => v::vmadd::vv(args, &mut self.registers.v, &self.vec_engine),
            Vmaddvx(args) => v::vmadd::vx(args, &mut self.registers.v, &self.vec_engine, &self.registers.x),

            Vnmsubvv(args) => v::vnmsub::vv(args, &mut self.registers.v, &self.vec_engine),
            Vnmsubvx(args) => v::vnmsub::vx(args, &mut self.registers.v, &self.vec_engine, &self.registers.x),

            Vmaccvv(args) => v::vmacc::vv(args, &mut self.registers.v, &self.vec_engine),
            Vmaccvx(args) => v::vmacc::vx(args, &mut self.registers.v, &self.vec_engine, &self.registers.x),

            Vnmsacvv(args) => v::vnmsac::vv(args, &mut self.registers.v, &self.vec_engine),
            Vnmsacvx(args) => v::vnmsac::vx(args, &mut self.registers.v, &self.vec_engine, &self.registers.x),

            Vwadduvv(args) => v::vwaddu::vv(args, &mut self.registers.v, &self.vec_engine),
            Vwadduvx(args) => v::vwaddu::vx(args, &mut self.registers.v, &self.vec_engine, &self.registers.x),

            Vwaddvv(args) => v::vwadd::vv(args, &mut self.registers.v, &self.vec_engine),
            Vwaddvx(args) => v::vwadd::vx(args, &mut self.registers.v, &self.vec_engine, &self.registers.x),

            Vwsubuvv(args) => v::vwsubu::vv(args, &mut self.registers.v, &self.vec_engine),
            Vwsubuvx(args) => v::vwsubu::vx(args, &mut self.registers.v, &self.vec_engine, &self.registers.x),

            Vwsubvv(args) => v::vwsub::vv(args, &mut self.registers.v, &self.vec_engine),
            Vwsubvx(args) => v::vwsub::vx(args, &mut self.registers.v, &self.vec_engine, &self.registers.x),

            Vwadduwv(args) => v::vwaddu::wv(args, &mut self.registers.v, &self.vec_engine),
            Vwadduwx(args) => v::vwaddu::wx(args, &mut self.registers.v, &self.vec_engine, &self.registers.x),

            Vwaddwv(args) => v::vwadd::wv(args, &mut self.registers.v, &self.vec_engine),
            Vwaddwx(args) => v::vwadd::wx(args, &mut self.registers.v, &self.vec_engine, &self.registers.x),

            Vwsubuwv(args) => v::vwsubu::wv(args, &mut self.registers.v, &self.vec_engine),
            Vwsubuwx(args) => v::vwsubu::wx(args, &mut self.registers.v, &self.vec_engine, &self.registers.x),

            Vwsubwv(args) => v::vwsub::wv(args, &mut self.registers.v, &self.vec_engine),
            Vwsubwx(args) => v::vwsub::wx(args, &mut self.registers.v, &self.vec_engine, &self.registers.x),

            Vwmuluvv(args) => v::vwmulu::vv(args, &mut self.registers.v, &self.vec_engine),
            Vwmuluvx(args) => v::vwmulu::vx(args, &mut self.registers.v, &self.vec_engine, &self.registers.x),

            Vwmulsuvv(args) => v::vwmulsu::vv(args, &mut self.registers.v, &self.vec_engine),
            Vwmulsuvx(args) => v::vwmulsu::vx(args, &mut self.registers.v, &self.vec_engine, &self.registers.x),

            Vwmulvv(args) => v::vwmul::vv(args, &mut self.registers.v, &self.vec_engine),
            Vwmulvx(args) => v::vwmul::vx(args, &mut self.registers.v, &self.vec_engine, &self.registers.x),

            Vwmaccuvv(args) => v::vwmaccu::vv(args, &mut self.registers.v, &self.vec_engine),
            Vwmaccuvx(args) => v::vwmaccu::vx(args, &mut self.registers.v, &self.vec_engine, &self.registers.x),

            Vwmaccvv(args) => v::vwmacc::vv(args, &mut self.registers.v, &self.vec_engine),
            Vwmaccvx(args) => v::vwmacc::vx(args, &mut self.registers.v, &self.vec_engine, &self.registers.x),

            Vwmaccusvx(args) => v::vwmaccus::vx(args, &mut self.registers.v, &self.vec_engine, &self.registers.x),

            Vwmaccsuvv(args) => v::vwmaccsu::vv(args, &mut self.registers.v, &self.vec_engine),
            Vwmaccsuvx(args) => v::vwmaccsu::vx(args, &mut self.registers.v, &self.vec_engine, &self.registers.x),

            Vfaddvv(args) => v::vfadd::vv(args, &mut self.registers.v, &self.vec_engine),
            Vfaddvf(args) => v::vfadd::vf(args, &mut self.registers.v, &self.vec_engine, &self.registers.f),
            ...
            Vfsubvf(args) => v::vfsub::vf(args, &mut self.registers.v, &self.vec_engine, &self.registers.f),
            ...
            Vfminvf(args) => v::vfmin::vf(args, &mut self.registers.v, &self.vec_engine, &self.registers.f),
            ...
            Vfmaxvf(args) => v::vfmax::vf(args, &mut self.registers.v, &self.vec_engine, &self.registers.f),
            ...
            Vfsgnjvf(args) => v::vfsgnj::vf(args, &mut self.registers.v, &self.vec_engine, &self.registers.f),

            Vfsgnjnvv(args) => v::vfsgnjn::vv(args, &mut self.registers.v, &self.vec_engine),
            Vfsgnjnvf(args) => v::vfsgnjn::vf(args, &mut self.registers.v, &self.vec_engine, &self.registers.f),

            Vfsgnjxvv(args) => v::vfsgnjx::vv(args, &mut self.registers.v, &self.vec_engine),
            Vfsgnjxvf(args) => v::vfsgnjx::vf(args, &mut self.registers.v, &self.vec_engine, &self.registers.f),

            Vfslide1upvf(args) => v::vfslide1up::vf(args, &mut self.registers.v, &self.vec_engine, &self.registers.f),

            Vfslide1downvf(args) => {
                v::vfslide1down::vf(args, &mut self.registers.v, &self.vec_engine, &self.registers.f)
            }

            Vfmvfs(args) => v::vfmv::fs(args, &self.registers.v, &self.vec_engine, &mut self.registers.f),

            Vfmvsf(args) => v::vfmv::sf(args, &mut self.registers.v, &self.vec_engine, &self.registers.f),
            ...
            VfwcvtRtzxufv(args) => v::vfwcvt::rtzxufv(args, &mut self.registers.v, &self.vec_engine),
            ...
            VfncvtRtzxufw(args) => v::vfncvt::rtzxufw(args, &mut self.registers.v, &self.vec_engine),
            ...
            Vfmergevfm(args) => v::vfmerge::vfm(args, &mut self.registers.v, &self.vec_engine, &self.registers.f),
            Vfmvvf(args) => v::vfmv::vf(args, &mut self.registers.v, &self.vec_engine, &self.registers.f),

            Vmfeqvv(args) => v::vmfeq::vv(args, &mut self.registers.v, &self.vec_engine),
            Vmfeqvf(args) => v::vmfeq::vf(args, &mut self.registers.v, &self.vec_engine, &self.registers.f),

            Vmflevv(args) => v::vmfle::vv(args, &mut self.registers.v, &self.vec_engine),
            Vmflevf(args) => v::vmfle::vf(args, &mut self.registers.v, &self.vec_engine, &self.registers.f),

            Vmfltvv(args) => v::vmflt::vv(args, &mut self.registers.v, &self.vec_engine),
            Vmfltvf(args) => v::vmflt::vf(args, &mut self.registers.v, &self.vec_engine, &self.registers.f),

            Vmfnevv(args) => v::vmfne::vv(args, &mut self.registers.v, &self.vec_engine),
            Vmfnevf(args) => v::vmfne::vf(args, &mut self.registers.v, &self.vec_engine, &self.registers.f),

            Vmfgtvf(args) => v::vmfgt::vf(args, &mut self.registers.v, &self.vec_engine, &self.registers.f),

            Vmfgevf(args) => v::vmfge::vf(args, &mut self.registers.v, &self.vec_engine, &self.registers.f),

            Vfdivvv(args) => v::vfdiv::vv(args, &mut self.registers.v, &self.vec_engine),
            Vfdivvf(args) => v::vfdiv::vf(args, &mut self.registers.v, &self.vec_engine, &self.registers.f),

            Vfrdivvf(args) => v::vfrdiv::vf(args, &mut self.registers.v, &self.vec_engine, &self.registers.f),

            Vfmulvv(args) => v::vfmul::vv(args, &mut self.registers.v, &self.vec_engine),
            Vfmulvf(args) => v::vfmul::vf(args, &mut self.registers.v, &self.vec_engine, &self.registers.f),

            Vfrsubvf(args) => v::vfrsub::vf(args, &mut self.registers.v, &self.vec_engine, &self.registers.f),

            Vfmaddvv(args) => v::vfmadd::vv(args, &mut self.registers.v, &self.vec_engine),
            Vfmaddvf(args) => v::vfmadd::vf(args, &mut self.registers.v, &self.vec_engine, &self.registers.f),

            Vfnmaddvv(args) => v::vfnmadd::vv(args, &mut self.registers.v, &self.vec_engine),
            Vfnmaddvf(args) => v::vfnmadd::vf(args, &mut self.registers.v, &self.vec_engine, &self.registers.f),

            Vfmsubvv(args) => v::vfmsub::vv(args, &mut self.registers.v, &self.vec_engine),
            Vfmsubvf(args) => v::vfmsub::vf(args, &mut self.registers.v, &self.vec_engine, &self.registers.f),

            Vfnmsubvv(args) => v::vfnmsub::vv(args, &mut self.registers.v, &self.vec_engine),
            Vfnmsubvf(args) => v::vfnmsub::vf(args, &mut self.registers.v, &self.vec_engine, &self.registers.f),

            Vfmaccvv(args) => v::vfmacc::vv(args, &mut self.registers.v, &self.vec_engine),
            Vfmaccvf(args) => v::vfmacc::vf(args, &mut self.registers.v, &self.vec_engine, &self.registers.f),

            Vfnmaccvv(args) => v::vfnmacc::vv(args, &mut self.registers.v, &self.vec_engine),
            Vfnmaccvf(args) => v::vfnmacc::vf(args, &mut self.registers.v, &self.vec_engine, &self.registers.f),

            Vfmsacvv(args) => v::vfmsac::vv(args, &mut self.registers.v, &self.vec_engine),
            Vfmsacvf(args) => v::vfmsac::vf(args, &mut self.registers.v, &self.vec_engine, &self.registers.f),

            Vfnmsacvv(args) => v::vfnmsac::vv(args, &mut self.registers.v, &self.vec_engine),
            Vfnmsacvf(args) => v::vfnmsac::vf(args, &mut self.registers.v, &self.vec_engine, &self.registers.f),

            Vfwaddvv(args) => v::vfwadd::vv(args, &mut self.registers.v, &self.vec_engine),
            Vfwaddvf(args) => v::vfwadd::vf(args, &mut self.registers.v, &self.vec_engine, &self.registers.f),
            ...
            Vfwsubvf(args) => v::vfwsub::vf(args, &mut self.registers.v, &self.vec_engine, &self.registers.f),
            ...
            Vfwaddwf(args) => v::vfwadd::wf(args, &mut self.registers.v, &self.vec_engine, &self.registers.f),

            Vfwsubwv(args) => v::vfwsub::wv(args, &mut self.registers.v, &self.vec_engine),
            Vfwsubwf(args) => v::vfwsub::wf(args, &mut self.registers.v, &self.vec_engine, &self.registers.f),

            Vfwmulvv(args) => v::vfmul::vv(args, &mut self.registers.v, &self.vec_engine),
            Vfwmulvf(args) => v::vfmul::vf(args, &mut self.registers.v, &self.vec_engine, &self.registers.f),

            Vfwmaccvv(args) => v::vfwmacc::vv(args, &mut self.registers.v, &self.vec_engine),
            Vfwmaccvf(args) => v::vfwmacc::vf(args, &mut self.registers.v, &self.vec_engine, &self.registers.f),

            Vfwnmaccvv(args) => v::vfwnmacc::vv(args, &mut self.registers.v, &self.vec_engine),
            Vfwnmaccvf(args) => v::vfwnmacc::vf(args, &mut self.registers.v, &self.vec_engine, &self.registers.f),

            Vfwmsacvv(args) => v::vfwmsac::vv(args, &mut self.registers.v, &self.vec_engine),
            Vfwmsacvf(args) => v::vfwmsac::vf(args, &mut self.registers.v, &self.vec_engine, &self.registers.f),

            Vfwnmsacvv(args) => v::vfwnmsac::vv(args, &mut self.registers.v, &self.vec_engine),
            Vfwnmsacvf(args) => v::vfwnmsac::vf(args, &mut self.registers.v, &self.vec_engine, &self.registers.f),
