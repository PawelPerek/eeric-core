...
impl<'m> Executor<'m> {
    ...
    pub fn execute(&mut self, input: Instruction) {
        ...
        match input {
            ...
            Vluxv { data: args, eew } => v::vlux::v(args, SEW::try_from(eew).unwrap(), &mut self.registers.v, &self.registers.x, &self.memory),
            Vloxv { data: args, eew } => v::vlox::v(args, SEW::try_from(eew).unwrap(), &mut self.registers.v, &self.registers.x, &self.memory),
            ...
            Vlffv { data: args, eew } => v::vlff::v(args, SEW::try_from(eew).unwrap(), &mut self.registers.v, &self.registers.x, &mut self.registers.c, &self.memory),

            Vlsegv {
                data: args,
                eew,
                nf,
            } => v::vlseg::v(args, SEW::try_from(eew).unwrap(), nf, &mut self.registers.v, &self.registers.x, &self.memory),
            Vssegv {
                data: args,
                eew,
                nf,
            } => v::vsseg::v(args, eew, nf, &self.registers.v, &mut self.memory),

            Vlssegv {
                data: args,
                eew,
                nf,
            } => v::vlsseg::v(args, eew, nf, &mut self.registers.v, &self.memory),
            Vsssegv {
                data: args,
                eew,
                nf,
            } => v::vssseg::v(args, eew, nf, &self.registers.v, &mut self.memory),
            ...
            Vloxsegv {
                ...
                eew,
                nf,
            } => v::vloxseg::v(args, eew, nf, &mut self.registers.v, &self.memory),
            Vsuxsegv {
                data: args,
                eew,
                nf,
            } => v::vsuxseg::v(args, eew, nf, &self.registers.v, &mut self.memory),
            Vsoxsegv {
                data: args,
                eew,
                nf,
            } => v::vsoxseg::v(args, eew, nf, &self.registers.v, &mut self.memory),
