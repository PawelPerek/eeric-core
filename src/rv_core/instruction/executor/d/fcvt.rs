use crate::rv_core::{instruction::{format::R, executor::f::utils::convert::compose}, registers::{FloatRegisters, IntegerRegisters}};

use super::super::f::utils::convert::decompose;
